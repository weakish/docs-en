...
> Before implementing these functions, go to your app's [Dashboard > Message > LeanMessage > Settings > LeanMessage Settings](/dashboard/messaging.html?appid={{appid}}#/message/realtime/conf) and enable **Allow editing messages with SDK** and **Allow recalling messages with SDK**.
...
1. Setting up a static message
  ...
  You can fill in a global static JSON string in your app's [Dashboard > Message > LeanMessage > Settings > Push Notification Settings](/dashboard/messaging.html?appid={{appid}}#/message/realtime/conf) for delivering push notifications with a static message. For example, if you put:
...
For the message set up in your app's [Dashboard > Message > LeanMessage > Settings > Push Notification Settings](/dashboard/messaging.html?appid={{appid}}#/message/realtime/conf), you can include the following variables:
